...
print("\nГотово!")
print("Средняя ошибка по концентрации: %2f %%" % (lossPer_s_accum*100))
print("Средняя ошибка по скорости: %2f %%" % (lossPer_v_accum*100))
print("Средняя ошибка по давлению: %2f %%" % (lossPer_p_accum*100))
print("Средняя общая ошибка: %2f %%" % (lossPer_accum*100))
